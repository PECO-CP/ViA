...
% $Revision: 2.0 $  $Date: 2021/12/02 23:43:54 $

% Last Modified by JONATHAN HOOD v3.0 Sep-2022

% ViA MacFix package within Figure package providing program-wide techical
% fix for MATLAB file communication with Macs.
