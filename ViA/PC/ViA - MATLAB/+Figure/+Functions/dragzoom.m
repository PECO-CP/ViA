...
% ViA Functions package within Figure package providing program-wide functions for
% graphical/mathematical support.
...
%==========================================================================
    function LinkAxesOn()
        ...
        temp = findobj('Tag','DualZoom');
        if ~isempty(temp)
            if ~fIsLinkAxesOn && temp.Value
                hAxes2d = GetHandlesAxes2D();
                if (length(hAxes2d) > 1)
